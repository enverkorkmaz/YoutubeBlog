            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3d5a3fb5-3d02-492a-94f5-9a701a8e0369",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ce343df5-51f7-46c5-8a7d-dff3fc82b24e",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "72863e8a-ffc1-434a-b7c1-114407104a06",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9ef9222f-7408-43e1-a81b-a38cc2e5b36f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEGw0hXruy9nhBno2qj8ypzXO6RzEgvJglbGKFjW0mHMa61dh0VELT3wjHs6BTywHQ==",
                            PhoneNumber = "+905418395771",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "5ac8f682-8039-4b61-a5a3-aac5bf5e0488",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "33b73133-07fd-4682-b62a-e7fcb7cac659",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENKMksB/CrFLHqQFJNNZ+M0bCfgARMsLfBsORADbsnF9FiTWwXEQdReNTO/s0eXZGQ==",
                            PhoneNumber = "+905418395772",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a9595b4c-46d7-4f59-ba4a-bfea2a91cb06",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("617b59ef-173d-4880-94f8-0ad3a82286e6"),
                            ...
                            CreatedDate = new DateTime(2023, 12, 22, 23, 50, 55, 969, DateTimeKind.Local).AddTicks(1370),
                            ImageId = new Guid("cb071202-b4b4-4b2d-b86b-a8a4441617bd"),
                        ...
                        new
                        {
                            Id = new Guid("297bcccb-4b9e-426c-af84-25f625a31ab1"),
                            CategoryId = new Guid("742851e4-12aa-49bf-b967-a3939d275173"),
                            Content = "Ormanda dolaşan küçük tavşan, rengarenk çiçekleri keşfetti. Masmavi gökyüzü altında sevinçle zıplayan tavşan, kuş cıvıltıları arasında kayboldu. Doğanın gizemine şahit olan tavşan, içsel huzur buldu.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 22, 23, 50, 55, 969, DateTimeKind.Local).AddTicks(1379),
                            ImageId = new Guid("f640303d-9f3b-442c-bdfd-070a2f7fe5eb"),
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 22, 23, 50, 55, 969, DateTimeKind.Local).AddTicks(1810),
                            Name = "ASP.NET Core",
                            ısDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 22, 23, 50, 55, 969, DateTimeKind.Local).AddTicks(1815),
                            Name = "ASP.NET31",
                            ısDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin test",
                            CreatedDate = new DateTime(2023, 12, 22, 23, 50, 55, 969, DateTimeKind.Local).AddTicks(2023),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "admin test",
                            CreatedDate = new DateTime(2023, 12, 22, 23, 50, 55, 969, DateTimeKind.Local).AddTicks(2035),
