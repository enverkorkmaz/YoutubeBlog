...
namespace YoutubeBlog.Data.Migrations
{
    ...
    [Migration("20231218201528_DALExtensions")]
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("99a6ad01-9350-4afe-ac0c-30869b48d6ae"),
                            ...
                            CreatedDate = new DateTime(2023, 12, 18, 23, 15, 27, 991, DateTimeKind.Local).AddTicks(3244),
                        ...
                        new
                        {
                            Id = new Guid("204ff876-8e93-44b2-929e-11125511e6a4"),
                            CategoryId = new Guid("742851e4-12aa-49bf-b967-a3939d275173"),
                            Content = "Ormanda dolaşan küçük tavşan, rengarenk çiçekleri keşfetti. Masmavi gökyüzü altında sevinçle zıplayan tavşan, kuş cıvıltıları arasında kayboldu. Doğanın gizemine şahit olan tavşan, içsel huzur buldu.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 18, 23, 15, 27, 991, DateTimeKind.Local).AddTicks(3265),
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 18, 23, 15, 27, 991, DateTimeKind.Local).AddTicks(3535),
                            Name = "ASP.NET Core",
                            ısDeleted = false
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 12, 18, 23, 15, 27, 991, DateTimeKind.Local).AddTicks(3539),
                            Name = "ASP.NET31",
                            ısDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin test",
                            CreatedDate = new DateTime(2023, 12, 18, 23, 15, 27, 991, DateTimeKind.Local).AddTicks(3720),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "admin test",
                            CreatedDate = new DateTime(2023, 12, 18, 23, 15, 27, 991, DateTimeKind.Local).AddTicks(3723),
