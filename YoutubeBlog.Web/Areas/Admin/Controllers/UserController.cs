...
namespace YoutubeBlog.Web.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(UserManager<AppUser> userManager, IMapper mapper, RoleManager<AppRole> roleManager,IValidator<AppUser> validator, IToastNotification toastNotification)
        {
